...
var Theme = (_a2 = class {
  ...
  updateColors() {
    var _a14, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H;
    ...
    this.radar = {
      axisColor: ((_a14 = this.radar) == null ? void 0 : _a14.axisColor) || this.lineColor,
    ...
    this.wardley = {
      backgroundColor: ((_k = this.wardley) == null ? void 0 : _k.backgroundColor) || this.background,
      axisColor: ((_l = this.wardley) == null ? void 0 : _l.axisColor) || this.lineColor,
      axisTextColor: ((_m = this.wardley) == null ? void 0 : _m.axisTextColor) || this.primaryTextColor,
      gridColor: ((_n = this.wardley) == null ? void 0 : _n.gridColor) || this.gridColor,
      componentFill: ((_o = this.wardley) == null ? void 0 : _o.componentFill) || this.background,
      componentStroke: ((_p = this.wardley) == null ? void 0 : _p.componentStroke) || this.lineColor,
      componentLabelColor: ((_q = this.wardley) == null ? void 0 : _q.componentLabelColor) || this.primaryTextColor,
...
var Theme2 = (_a3 = class {
  ...
  updateColors() {
    ...
    this.quadrantTitleFill = this.quadrantTitleFill || this.primaryTextColor;
    this.xyChart = {
      backgroundColor: ((_a14 = this.xyChart) == null ? void 0 : _a14.backgroundColor) || this.background,
      titleColor: ((_b = this.xyChart) == null ? void 0 : _b.titleColor) || this.primaryTextColor,
      dataLabelColor: ((_c = this.xyChart) == null ? void 0 : _c.dataLabelColor) || this.primaryTextColor,
      ...
      plotColorPalette: ((_l = this.xyChart) == null ? void 0 : _l.plotColorPalette) || "#3498db,#2ecc71,#e74c3c,#f1c40f,#bdc3c7,#ffffff,#34495e,#9b59b6,#1abc9c,#e67e22"
    };
    this.packet = {
    ...
    this.radar = {
      axisColor: ((_m = this.radar) == null ? void 0 : _m.axisColor) || this.lineColor,
      axisStrokeWidth: ((_n = this.radar) == null ? void 0 : _n.axisStrokeWidth) || 2,
      axisLabelFontSize: ((_o = this.radar) == null ? void 0 : _o.axisLabelFontSize) || 12,
      curveOpacity: ((_p = this.radar) == null ? void 0 : _p.curveOpacity) || 0.5,
      curveStrokeWidth: ((_q = this.radar) == null ? void 0 : _q.curveStrokeWidth) || 2,
...
var Theme5 = (_a6 = class {
  ...
  updateColors() {
    ...
    this.xyChart = {
      ...
      yAxisTickColor: ((_j = this.xyChart) == null ? void 0 : _j.yAxisTickColor) || this.primaryTextColor,
      yAxisLineColor: ((_k = this.xyChart) == null ? void 0 : _k.yAxisLineColor) || this.primaryTextColor,
      plotColorPalette: ((_l = this.xyChart) == null ? void 0 : _l.plotColorPalette) || "#EEE,#6BB8E4,#8ACB88,#C7ACD6,#E8DCC2,#FFB2A8,#FFF380,#7E8D91,#FFD8B1,#FAF3E0"
    };
    this.radar = {
      axisColor: ((_m = this.radar) == null ? void 0 : _m.axisColor) || this.lineColor,
      axisStrokeWidth: ((_n = this.radar) == null ? void 0 : _n.axisStrokeWidth) || 2,
...
var Theme6 = (_a7 = class {
  ...
  updateColors() {
    var _a14, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k;
    this.primaryTextColor = this.primaryTextColor || (this.darkMode ? "#eee" : "#333");
    this.secondaryColor = this.secondaryColor || adjust_default(this.primaryColor, { h: -120 });
    this.tertiaryColor = this.tertiaryColor || adjust_default(this.primaryColor, { h: 180, l: 5 });
    this.primaryBorderColor = this.primaryBorderColor || mkBorder(this.primaryColor, this.darkMode);
...
var addDirective = __name((directive) => {
  ...
  if (directive.fontFamily && !((_a14 = directive.themeVariables) == null ? void 0 : _a14.fontFamily)) {
...
var getEffectiveHtmlLabels = __name((config2) => {
  var _a14, _b;
  if (((_a14 = config2.flowchart) == null ? void 0 : _a14.htmlLabels) != void 0) {
...
var hasKatex = __name((text2) => {
  var _a14;
  return (((_a14 = text2.match(katexRegex)) == null ? void 0 : _a14.length) ?? 0) > 0;
}, "hasKatex");
...
var renderKatexUnsanitized = __name(async (text2, config2) => {
  ...
  if (true) {
    const { default: katex } = await import("./katex-QCRZHRLU.js");
...
var registerDiagram = __name((id, diagram, detector) => {
  ...
  (_a14 = diagram.injectUtils) == null ? void 0 : _a14.call(
    diagram,
    log2,
    setLogLevel2,
    getConfig2,
...
var _a13;
var DiagramNotFoundError = (_a13 = class extends Error {
  constructor(name) {
    super(`Diagram ${name} not found.`);
  }
}, __name(_a13, "DiagramNotFoundError"), _a13);
...
*/
//# sourceMappingURL=chunk-QFOGR2KV.js.map
