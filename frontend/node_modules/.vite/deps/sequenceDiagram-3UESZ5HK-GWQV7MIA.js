...
var drawActorTypeParticipant = __name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  var _a2, _b;
...
var drawActorTypeCollections = __name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  var _a2, _b;
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + actor.height;
...
var drawActorTypeQueue = __name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  var _a2, _b;
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + actor.height;
...
var drawActorTypeEntity = __name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  var _a2;
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + 75;
...
var drawActorTypeDatabase = __name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  var _a2;
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeBoundary = __name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var insertDropShadow = __name(function(elem, conf2) {
  const { theme } = conf2;
...
//# sourceMappingURL=sequenceDiagram-3UESZ5HK-GWQV7MIA.js.map
