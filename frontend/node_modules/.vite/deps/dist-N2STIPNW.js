import {
  selectSvgElement
} from "./chunk-2UBM54XZ.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-VPH2YATB.js";
import {
  registerLayoutLoaders
} from "./chunk-PE7RFD4J.js";
import "./chunk-ZLKDU2AU.js";
import "./chunk-QIILK6SK.js";
import "./chunk-VJFKZZXH.js";
import "./chunk-FGAWXSH6.js";
import "./chunk-KYLTHSDW.js";
import "./chunk-A3RWWFAI.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-JVWSDRU7.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
  ...
  removeDirectives,
  utils_default
} from "./chunk-TG6FPCH3.js";
import "./chunk-ZM5GOABW.js";
import {
  UnknownDiagramError,
  addDirective,
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-QFOGR2KV.js";
import {
  __name,
  log,
  select_default,
  setLogLevel
} from "./chunk-MCXSICRQ.js";
import {
  __commonJS,
  __toESM
...
var computeGroupIds = (graph) => {
  ...
  const mapper = {};
  [...Object.keys(graph.vertices), ...graph.subGraphs.map((c) => c.id)].forEach((id33) => {
    if (!tree[id33]) {
      return;
    }
    let curr = tree[id33];
...
var nanoid = (size = 21) => crypto.getRandomValues(new Uint8Array(size)).reduce((id33, byte) => {
  byte &= 63;
  if (byte < 36) {
    id33 += byte.toString(36);
  } else if (byte < 62) {
    id33 += (byte - 26).toString(36).toUpperCase();
  } else if (byte > 62) {
    id33 += "-";
  } else {
    id33 += "_";
      ...
      chart.groups.forEach((group) => {
        ...
        const actors = elements.filter((ele) => {
          if (ele.id) {
            ...
            const id33 = ele.id.substring(0, hyphenIndex);
            return actorKeys.includes(id33);
          }
          return false;
        });
        if (!actors.length) {
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-AAUBKEIU-MGH4T3TY.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-I6XJVG4X-WU3RF75K.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-TEJ5UH35-SVDCJEMO.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-PVQCEYII-ALDU5SE7.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-6RSMTGT7-ILYFMAG7.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-5YYISTIA-E7KXUIH5.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-4H26LBE5-ZKIJWRNQ.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-W4KKPZXB-4R6KBUUP.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-2RQKCTM6-PDYI5RJ5.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-4Y6WPE33-DLK2XI7T.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-3UESZ5HK-GWQV7MIA.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-4FO5ZUOK-3QKFOMHQ.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-Q7XG4LA2-CE5XO76G.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-AJRCARHV-3CYC6OHT.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-BHNVJYJU-5YVJ3JSC.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-JHISSGLW-KYMOMWUS.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-PNZ67QCA-BKQ4F6JH.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-RKZ34NQL-GFYLQBHD.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-UN3LZRKU-PZYUZ32I.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-5OEKKPKP-2PP3LBZD.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-LMA3HP47-44N5OSVX.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-2AECGRRQ-AHFPOKFI.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-GPEHLZMM-SWUEKQ7Z.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-5GNKFQAL-WKIMVJTM.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-3BPJPVTR-PDURHS6U.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-KO2AKTUF-5AGPFM6I.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-YF4QCWOH-TSM6J3SL.js");
...
var loader30 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-CIIHVFJN-CYI2I2QP.js");
...
var loader31 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-OG6HWLK6-YUR4DFGQ.js");
...
var loader32 = __name(async () => {
  const { diagram: diagram2 } = await import("./wardleyDiagram-YWT4CUSO-METKSN7W.js");
...
var render = __name(async function(id33, text, svgContainingElement) {
...
var render2 = __name((id33, text, container) => {
  return new Promise((resolve, reject) => {
    const performCall = __name(() => new Promise((res, rej) => {
...
var parseMermaidFlowChartDiagram = (db, containerEl) => {
  ...
  if (verticesData instanceof Map) {
    verticesData.forEach((vertex, id33) => {
      vertices[id33] = parseVertex(vertex, containerEl, normalizedClasses);
    });
  } else if (typeof verticesData === "object" && verticesData !== null) {
    Object.entries(verticesData).forEach(([id33, vertex]) => {
      vertices[id33] = parseVertex(vertex, containerEl, normalizedClasses);
    });
  }
...
var createContainerSkeletonFromSVG = (node2, type, opts = {}) => {
  const container = {};
  container.type = type;
  const { label, subtype, id: id33, groupId } = opts;
  container.id = id33;
  if (groupId) {
...
var createActorSymbol = (rootNode, text, opts) => {
  ...
  children.forEach((child, index) => {
    const id33 = `${opts == null ? void 0 : opts.id}-${index}`;
    let ele;
    switch (child.tagName) {
      case "line":
        ...
        ele = createLineSkeletonFromSVG(child, startX, startY, endX, endY, { groupId, id: id33 });
        break;
      case "text":
...
var parseClasses = (classes, containerEl, lookUpDomId) => {
  ...
  Object.values(classes).forEach((classNode) => {
    ...
    const findByPrefix = (id33) => {
      const regex = new RegExp(`^classId-${id33}(?:-|$)`);
...
var parseNotes = (notes, containerEl, classNodes) => {
  ...
  notes.forEach((note, index) => {
    const { id: id33, text, class: classId } = note;
    const node2 = containerEl.querySelector(`#${id33}`);
    if (!node2) {
      throw new Error(`Node with id ${id33} not found!`);
    }
...
mermaid/dist/mermaid.core.mjs:
   ...
   *)
*/
//# sourceMappingURL=dist-N2STIPNW.js.map
