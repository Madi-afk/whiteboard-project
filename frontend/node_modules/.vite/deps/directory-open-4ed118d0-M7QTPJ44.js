...
function e(r2) {
  function t2(e2) {
    if (Object(e2) !== e2) return Promise.reject(new TypeError(e2 + " is not an object."));
    var r3 = e2.done;
  ...
  try {
    for (var y, f = (function(r2) {
      ...
      for ("undefined" != typeof Symbol && (n2 = Symbol.asyncIterator, i2 = Symbol.iterator); a2--; ) {
        if (n2 && null != (t3 = r2[n2])) return t3.call(r2);
        if (i2 && null != (t3 = r2[i2])) return new e(t3.call(r2));
...
//# sourceMappingURL=directory-open-4ed118d0-M7QTPJ44.js.map
